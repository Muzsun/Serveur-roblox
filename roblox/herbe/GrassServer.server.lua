...
-- Ordre : GrassConfig.ZONES_ORDER = {"Zone","ZonePorte",...} si tu le mets, sinon de la plus proche du spawn à la plus loin.
...
task.spawn(function()
	...
	local rank={}
	if typeof(CFG.ZONES_ORDER)=="table" then for i,n in CFG.ZONES_ORDER do rank[n]=i end end
